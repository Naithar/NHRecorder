...
[[NSBundle bundleForClass:[NHCropCollectionDefaultViewCell class]]\
pathForResource:name ofType:@"png"]]

#define localization(name, table) \
NSLocalizedStringFromTableInBundle(name, \
table, \
[NSBundle bundleForClass:[NHCropCollectionDefaultViewCell class]], nil)

@interface NHCropCollectionDefaultViewCell ()
...
@implementation NHCropCollectionDefaultViewCell
